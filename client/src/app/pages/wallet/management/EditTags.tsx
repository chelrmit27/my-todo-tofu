...
const EditTags = () => {
  ...
  const handleSave = async () => {
    if (selectedCategory) {
      try {
        ...
        await axios.patch(`${BASE_URL}/categories/${selectedCategory}`, editedCategory, config);
  ...
  const handleDelete = async () => {
    if (selectedCategory) {
      try {
        ...
        await axios.delete(`${BASE_URL}/categories/${selectedCategory}`, config);
  ...
  const handleAddCategory = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URL}/categories`, newCategory, config);
